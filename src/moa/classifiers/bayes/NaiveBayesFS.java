 ...
 * @version $Revision: 7 $
 */
public class NaiveBayesFS extends AbstractClassifier {
    ...
    public static IntOption fsmethodOption = new IntOption("fsMethod", 'm', "Infotheoretic method used to select features: 0. InfoGain 1. Symmetrical Uncertainty 2. OFSGD", 0, 0, 2);
